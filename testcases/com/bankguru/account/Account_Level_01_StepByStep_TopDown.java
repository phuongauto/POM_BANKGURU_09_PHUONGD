...
public class Account_Level_01_StepByStep_TopDown {
	...
	public void TC01_RegisterToSystem() {
		...
		/*
		 * User ID : mngr190908 Password : ujEjuqA
		 */
		/*
		 * ở đây nếu khai báo String loginPageUrl = driver.getCurrentUrl(); thì thằng
		 * loginPageUrl chỉ được dùng trong TC01_RegisterToSystem() này mà thôi. Do đó
		 * ta khai báo String loginPageUrl lên trên đầu class để có thể tái sử dụng ở
		 * các @Test khác Tương tự đối với userIDInfor, passwordInfor
		 */
	}
